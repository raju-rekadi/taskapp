  ...
  useEffect(() => {
    ...
    try {
      ...
      Sem1Results.forEach(student => {
        ...
        const average = totalCreditHours
          ? (totalWeightedGradePoints / totalCreditHours).toFixed(2)
          : "0.00";
      ...
      Object.keys(combined).forEach(hallTicket => {
        ...
        student.cgpa = totalCreditHours 
          ? (totalCreditPoints / totalCreditHours).toFixed(2)
          : "0.00";
      });
  ...
  const filteredAndSortedResults = [...allResults]
    .filter(student => {
      ...
      return (
        ...
        student.hallTicket.toLowerCase().includes(searchLower)
      );
    })
    .sort((a, b) => {
      if (sortOrder === 'asc') return parseFloat(a.average) - parseFloat(b.average);
      if (sortOrder === 'desc') return parseFloat(b.average) - parseFloat(a.average);
      ...
      <div className="bg-white rounded-lg shadow px-4 py-6 flex flex-col md:flex-row justify-between items-center">
        <div className="text-center md:text-left">
          ...
          <p className="text-base sm:text-lg text-gray-700">
            B.Sc. Computer Science Examination Results (2023-2026)
          </p>
        </div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full table-auto border-collapse">
                        ...
                        <tbody>
                          {combinedResults[student.hallTicket]?.semesters[student.activeSemester]?.results.map((r, i) => (
